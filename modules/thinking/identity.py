...
DEFAULT_TOOL_WHITELISTS: Dict[str, List[str]] = {
    ...
    "expert_code_reviewer": ["memory_match", "event_query", "probe_list"],
    "code_reviewer": ["memory_match", "event_query", "probe_list"],
    "expert_code_writer": ["run_command", "event_query", "probe_list"],
    "code_writer": ["run_command", "event_query", "probe_list"],
    "expert_test_writer": ["run_pytest", "run_command", "event_query", "probe_list"],
    "tester": ["run_pytest", "run_command", "event_query", "probe_list"],
    "expert_data_analyzer": ["web_search", "memory_match", "event_query", "probe_list"],
    "expert_customer": ["event_query", "probe_list"],
    "expert_emotion": ["event_query", "probe_list"],
    "expert_creative_writer": ["event_query", "probe_list"],
}
